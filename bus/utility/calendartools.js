define(['cCoreInherit','cUtilCommon','cUtilDate'], function (cCoreInherit,cUtilCommon,cUtilDate) {


  var CalendarTools = new cCoreInherit.Class({
    propertys: function () {
      this.CONSTANT = {
    ...
    getDateInfo: function (date) {
        ...
        var today = cUtilCommon.getServerDate();
        ...
        if (cUtilDate.format(today, 'Ymd') == cUtilDate.format(date, 'Ymd')) {
          info.daytitle = '今天';
        } else if (day == 1) {
          info.daytitle = '明天';
        } else if (day == 2) {
        ...
        var gkey = cUtilDate.format(date, 'md')
        ...
        info.date = cUtilDate.format(date, 'j');
        return info;
    }
  });

  var calendar = new CalendarTools();
  
  return {
      getDateInfo:function(date){
          return calendar.getDateInfo(date);
      },
      calendar:calendar
  };
});